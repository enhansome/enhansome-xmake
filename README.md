...
Your contributions are highly welcome (first see [CONTRIBUTING.md](https://github.com/tboox/awesome-xmake/blob/master/CONTRIBUTING.md) ⭐ 71 | 🐛 0 | 📅 2021-12-22).
...
* [Dash-docsets (xmake)](https://github.com/Kapeli/Dash-User-Contributions/tree/master/docsets/XMake) ⭐ 2,055 | 🐛 206 | 🌐 Python | 📅 2026-08-27: Thanks [@kassane](https://github.com/kassane)
* [English Documents](https://xmake.io/#/home)
* [Chinese Documents](https://xmake.io/#/zh/)

## Repositories

* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 934 | 🐛 345 | 🌐 Xmake | 📅 2026-09-04: An official xmake package repository
...
* [xmake-vscode](https://github.com/xmake-io/xmake-vscode) ⭐ 273 | 🐛 71 | 🌐 TypeScript | 📅 2026-08-19: A VSCode plugin for xmake
* [xmake-idea](https://github.com/xmake-io/xmake-idea) ⭐ 107 | 🐛 6 | 🌐 Kotlin | 📅 2026-08-18: A Intellij-IDEA plugin for xmake
...
* [xmake-qtcreator](https://github.com/Arthapz/xmake-project-manager) ⚠️ Archived (third-party, thanks [@Arthapz](https://github.com/Arthapz))
* [xmake-visualstudio](https://github.com/HelloWorld886/xmake-visualstudio) ⭐ 24 | 🐛 5 | 🌐 C# | 📅 2025-02-02 (third-party, thanks [@HelloWorld886](https://github.com/HelloWorld886))
* [xmake-sublime](https://github.com/xmake-io/xmake-sublime) ⭐ 22 | 🐛 1 | 🌐 Python | 📅 2024-07-15: A Sublime Text 2/3 plugin for xmake

## Projects

* [Add xmake to libuv](https://github.com/libuv/libuv/pull/1464) ⭐ 27,158 | 🐛 232 | 🌐 C | 📅 2026-09-01: Add xmake.lua file to make it easier to build libuv
* [tbox](https://github.com/tboox/tbox) ⭐ 5,122 | 🐛 37 | 🌐 C | 📅 2026-08-28: A glib-like multi-platform c library
* [CyberEngineTweaks](https://github.com/yamashi/CyberEngineTweaks) ⭐ 4,806 | 🐛 40 | 🌐 C++ | 📅 2026-05-09: Performance boost, bug fixes and hacks for fun for Cyberpunk 2077
* [co](https://github.com/idealvin/co) ⭐ 4,210 | 🐛 15 | 🌐 C++ | 📅 2025-05-27: An elegant and efficient C++ basic library for Linux, Windows and Mac.
* [hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,484 | 🐛 5 | 🌐 C++ | 📅 2026-09-04: Hikyuu Quant Framework 基于C++/Python的开源量化交易研究框架
* [libacl](https://github.com/acl-dev/acl) ⭐ 3,103 | 🐛 40 | 🌐 C | 📅 2026-08-13: An advanced C/C++ Network library
* [zsign](https://github.com/zhlynn/zsign) ⭐ 1,856 | 🐛 2 | 🌐 C++ | 📅 2026-08-21: Maybe is the most quickly codesign alternative for iOS12+ in the world, cross-platform ( Linux & macOS ).
* [StereoKit](https://github.com/maluoi/StereoKit) ⭐ 1,078 | 🐛 162 | 🌐 C++ | 📅 2026-09-04: An easy-to-use mixed reality library for building HoloLens and VR applications with C# and OpenXR!
...
* [nmscc](https://github.com/lumpyzhu/nmscc) ⭐ 208 | 🐛 0 | 🌐 C++ | 📅 2026-08-31: the missing c++ 1z library.
* [rc](https://github.com/lumpyzhu/rc) ⭐ 208 | 🐛 0 | 🌐 C++ | 📅 2026-08-31: rc is rust in c++
* [itrace](https://github.com/tboox/itrace) ⭐ 207 | 🐛 1 | 🌐 C | 📅 2019-04-13：Trace objc method call for ios and mac
...
* [libsv](https://github.com/uael/sv) ⭐ 76 | 🐛 3 | 🌐 C | 📅 2026-04-06: Public domain semantic versioning in c.
* [Gobang](https://github.com/Leopard-C/Gobang) ⭐ 75 | 🐛 2 | 🌐 C++ | 📅 2020-03-11: 五子棋游戏，游戏双方联网对战
* [BurgWar](https://github.com/DigitalPulseSoftware/BurgWar) ⭐ 54 | 🐛 23 | 🌐 C++ | 📅 2024-08-26: Burg'war est un jeu de plateforme/combat multijoueur en 2D écrit en C++17/Lua avec mon propre moteur de jeu : Nazara Engine.
* [benchbox](https://github.com/tboox/benchbox) ⭐ 33 | 🐛 0 | 🌐 C | 📅 2021-09-27: The Benchmark Testing Box
* [lcui-router-app](https://github.com/lc-ui/lcui-router-app) ⚠️ Archived: A simple application for LCUI Router
* [TiltedCore](https://github.com/tiltedphoques/TiltedCore) ⭐ 19 | 🐛 1 | 🌐 C++ | 📅 2026-08-24: This is the core library used by all C++ projects by Tilted Phoques.
* [ctxco](https://github.com/codehz/ctxco) ⭐ 18 | 🐛 0 | 🌐 C | 📅 2020-01-09: Minimal (and intuitive to use) coroutine implement in c
...
* [Sound\_THUMB](https://github.com/Yunoinsky/Sound_THUMB) ⭐ 7 | 🐛 0 | 🌐 C | 📅 2019-12-24: 这是一个THUMB的增强现实有音乐元素的美少女/美少年的抽卡氪金手游
* [Btk](https://github.com/BusyStudent/Btk) ⚠️ Archived: A library for developing Gui based on SDL2
* [Btk](https://github.com/BusyStudent/Btk) ⚠️ Archived: A library for developing Gui based on SDL2
* [EasyCrossPlatform\_src](https://github.com/EasyCrossPlatformLib/EasyCrossPlatform_src) ⚠️ Archived: An easy-to-use crossplatform C++ Library, primarily for server-side development.
* [coros](https://github.com/jfjia/coros) ⭐ 6 | 🐛 0 | 🌐 C++ | 📅 2023-04-09: c++11 coroutine network library base on boost.context and libuv
* [Vectorizer](https://github.com/DoubleCouponDay/Vectorizer) ⚠️ Archived
* [xmake-cpputest](https://github.com/longbai/xmake-cpputest) ⭐ 5 | 🐛 0 | 🌐 C | 📅 2022-01-07: Setup test project for embedded C development with CppUTest built using XMake
* [UWPFlow](https://github.com/OpportunityLiu/UWPFlow) ⭐ 5 | 🐛 1 | 🌐 C++ | 📅 2026-06-02: UW Continuation Power Flow
* [TensorIR](https://github.com/zhangxp1998/TensorIR) ⭐ 5 | 🐛 0 | 🌐 Scala | 📅 2020-05-28
* [srpc](https://github.com/luzhlon/srpc) ⭐ 4 | 🐛 1 | 🌐 C++ | 📅 2017-08-27: srpc是一个基于TCP流和msgpack的RPC协议
* [userver](https://github.com/dreamtraveler/userver) ⭐ 4 | 🐛 0 | 🌐 C | 📅 2018-10-22: A c++ game server framework based on libuv
* [xval](https://github.com/luzhlon/xval) ⭐ 3 | 🐛 0 | 🌐 C++ | 📅 2017-08-09: xval是一个轻量级的C++动态类型对象库，主要用于与其他动态语言的通信
* [ttp](https://github.com/codehz/ttp) ⭐ 3 | 🐛 0 | 🌐 C | 📅 2019-12-20: Minimal HTTP library (pure)
* [dnn](https://github.com/garraGH/dnn) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2020-02-06: Framework for deep neural network using c++/cuda/opengl
* [cgraph](https://github.com/liurunzhan/cgraph) ⭐ 2 | 🐛 0 | 🌐 C | 📅 2023-07-05: A C LIBRARY FOR GRAPH ANALYSIS
* [VkRender](https://github.com/WubiCookie/VkRenderer) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2021-03-17
* [boost\_ptree\_example](https://github.com/wyy584322202/boost_ptree_example) ⭐ 1 | 🐛 0 | 🌐 C++ | 📅 2016-12-22: 使用ptree处理json
* [fileSys](https://github.com/zmz1998/fileSys) ⭐ 1 | 🐛 0 | 🌐 C | 📅 2020-10-09: virtul fileSystem in linux
* [tlpi\_hdr](https://github.com/frostRed/tlpi_hdr) ⭐ 0 | 🐛 0 | 🌐 Rust | 📅 2020-03-12: The Linux programming interface codes
* [json](https://github.com/xyliuke/json) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2018-05-15: A json parser
* [DA-MD5](https://github.com/DATechnologyStudio/DA-MD5) ⚠️ Archived: A changeable data MD5 library by DA studio
* [aoc2019](https://github.com/wrren/aoc2019) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2019-12-04: Advent of Code 2019 Solutions
* [FengEngine](https://github.com/libyyu/FengEngine) ⭐ 0 | 🐛 0 | 🌐 C | 📅 2019-12-15
* [chimney-c](https://github.com/Evan2698/chimney-c) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2020-04-20
* [kvm](https://github.com/wrren/kvm) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2020-10-21: Use DDC/CI to change your monitor's inputs in response to USB device connect or disconnect events.
* [CLRS](https://github.com/bamceil/CLRS) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2020-11-07
* [swe](https://github.com/jaratma/swe) ⭐ 0 | 🐛 0 | 🌐 C | 📅 2020-10-11
* [IntroSTL](https://github.com/bamceil/IntroSTL) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2021-04-14
* [dson](https://github.com/bamceil/dson) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2020-10-04
* [mot](https://github.com/vsensu/mot) ⭐ 0 | 🐛 0 | 🌐 C++ | 📅 2021-05-17
...
* [shadowssh\_rule\_c](https://github.com/ChanthMiao/shadowssh_rule_c): the calculation lib example of shadowssh
...
* [cv\_learning](https://github.com/Biobots/cv_learning)
...
* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 934 | 🐛 345 | 🌐 Xmake | 📅 2026-09-04: A package repository based on xmake
