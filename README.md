...
* [Dash-docsets (xmake)](https://github.com/Kapeli/Dash-User-Contributions/tree/master/docsets/XMake) ⭐ 2,057 | 🐛 210 | 🌐 Python | 📅 2026-08-27: Thanks [@kassane](https://github.com/kassane)
* [English Documents](https://xmake.io/#/home)
* [Chinese Documents](https://xmake.io/#/zh/)

## Repositories

* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 934 | 🐛 337 | 🌐 Xmake | 📅 2026-09-17: An official xmake package repository
...
* [Add xmake to libuv](https://github.com/libuv/libuv/pull/1464) ⭐ 27,175 | 🐛 233 | 🌐 C | 📅 2026-09-16: Add xmake.lua file to make it easier to build libuv
* [tbox](https://github.com/tboox/tbox) ⭐ 5,123 | 🐛 37 | 🌐 C | 📅 2026-09-15: A glib-like multi-platform c library
...
* [co](https://github.com/idealvin/co) ⭐ 4,214 | 🐛 6 | 🌐 C++ | 📅 2026-09-17: An elegant and efficient C++ basic library for Linux, Windows and Mac.
* [hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,511 | 🐛 4 | 🌐 C++ | 📅 2026-09-12: Hikyuu Quant Framework 基于C++/Python的开源量化交易研究框架
...
* [StereoKit](https://github.com/maluoi/StereoKit) ⭐ 1,078 | 🐛 159 | 🌐 C++ | 📅 2026-09-17: An easy-to-use mixed reality library for building HoloLens and VR applications with C# and OpenXR!
...
* [nmscc](https://github.com/lumpyzhu/nmscc) ⭐ 208 | 🐛 0 | 🌐 C++ | 📅 2026-09-17: the missing c++ 1z library.
* [rc](https://github.com/lumpyzhu/rc) ⭐ 208 | 🐛 0 | 🌐 C++ | 📅 2026-09-17: rc is rust in c++
...
* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 934 | 🐛 337 | 🌐 Xmake | 📅 2026-09-17: A package repository based on xmake
