...
* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 933 | 🐛 348 | 🌐 Xmake | 📅 2026-09-10: An official xmake package repository
...
* [Add xmake to libuv](https://github.com/libuv/libuv/pull/1464) ⭐ 27,166 | 🐛 236 | 🌐 C | 📅 2026-09-08: Add xmake.lua file to make it easier to build libuv
* [tbox](https://github.com/tboox/tbox) ⭐ 5,124 | 🐛 37 | 🌐 C | 📅 2026-08-28: A glib-like multi-platform c library
...
* [hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,495 | 🐛 4 | 🌐 C++ | 📅 2026-09-09: Hikyuu Quant Framework 基于C++/Python的开源量化交易研究框架
* [libacl](https://github.com/acl-dev/acl) ⭐ 3,102 | 🐛 40 | 🌐 C | 📅 2026-08-13: An advanced C/C++ Network library
* [zsign](https://github.com/zhlynn/zsign) ⭐ 1,860 | 🐛 2 | 🌐 C++ | 📅 2026-08-21: Maybe is the most quickly codesign alternative for iOS12+ in the world, cross-platform ( Linux & macOS ).
* [StereoKit](https://github.com/maluoi/StereoKit) ⭐ 1,077 | 🐛 163 | 🌐 C++ | 📅 2026-09-04: An easy-to-use mixed reality library for building HoloLens and VR applications with C# and OpenXR!
...
* [nmscc](https://github.com/lumpyzhu/nmscc) ⭐ 208 | 🐛 0 | 🌐 C++ | 📅 2026-09-10: the missing c++ 1z library.
* [rc](https://github.com/lumpyzhu/rc) ⭐ 208 | 🐛 0 | 🌐 C++ | 📅 2026-09-10: rc is rust in c++
...
* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 933 | 🐛 348 | 🌐 Xmake | 📅 2026-09-10: A package repository based on xmake
