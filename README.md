...
* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 934 | 🐛 342 | 🌐 Xmake | 📅 2026-09-06: An official xmake package repository
...
* [xmake-vscode](https://github.com/xmake-io/xmake-vscode) ⭐ 273 | 🐛 72 | 🌐 TypeScript | 📅 2026-08-19: A VSCode plugin for xmake
...
* [Add xmake to libuv](https://github.com/libuv/libuv/pull/1464) ⭐ 27,159 | 🐛 234 | 🌐 C | 📅 2026-09-06: Add xmake.lua file to make it easier to build libuv
* [tbox](https://github.com/tboox/tbox) ⭐ 5,123 | 🐛 37 | 🌐 C | 📅 2026-08-28: A glib-like multi-platform c library
* [CyberEngineTweaks](https://github.com/yamashi/CyberEngineTweaks) ⭐ 4,807 | 🐛 40 | 🌐 C++ | 📅 2026-05-09: Performance boost, bug fixes and hacks for fun for Cyberpunk 2077
* [co](https://github.com/idealvin/co) ⭐ 4,210 | 🐛 15 | 🌐 C++ | 📅 2025-05-27: An elegant and efficient C++ basic library for Linux, Windows and Mac.
* [hikyuu](https://github.com/fasiondog/hikyuu) ⭐ 3,489 | 🐛 4 | 🌐 C++ | 📅 2026-09-04: Hikyuu Quant Framework 基于C++/Python的开源量化交易研究框架
* [libacl](https://github.com/acl-dev/acl) ⭐ 3,102 | 🐛 40 | 🌐 C | 📅 2026-08-13: An advanced C/C++ Network library
...
* [xmake-repo](https://github.com/xmake-io/xmake-repo) ⭐ 934 | 🐛 342 | 🌐 Xmake | 📅 2026-09-06: A package repository based on xmake
